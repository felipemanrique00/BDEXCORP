...
$task = New-ScheduledTask -Action $action -Trigger $trigger -Principal $principal -Settings $settings -Description 'Inicia e supervisiona o BDEX local, PostgreSQL embarcado e Next.js na porta 3010.'
