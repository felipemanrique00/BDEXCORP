...
-- Rejeicoes de aprovacao podem devolver a solicitacao para uma correcao
-- explicita. O comando e a chave idempotente continuam obrigatorios pelo
-- trigger, impedindo qualquer alteracao manual de lifecycle_status.
...
declare
  ...
  allowed_transitions text[] := array[
    ...
    'pending_merit_approval>submitted', 'pending_merit_approval>approved_for_quotation',
    'approved_for_quotation>quoting', 'quoting>pending_choice', 'pending_choice>quoting',
    'pending_choice>submitted', 'pending_choice>pending_cost_approval', 'pending_choice>approved',
