  ...
  return (
    <div className="space-y-5 animate-fade-in">
      <div className="bbt-page-header">
        <div>
          <p className="bbt-section-label">Compliance</p>
          <h1 className="bbt-page-title flex items-center gap-2 mt-1">
            <ShieldCheck className="w-6 h-6 text-bbt-accent" /> Aprovações
          </h1>
          <p className="bbt-page-subtitle">
            Workflow multi-nível de aprovação de viagens fora da política.
          </p>
        </div>
      </div>
